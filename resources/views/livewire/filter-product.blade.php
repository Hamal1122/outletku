...
<div>
  <div>
    ...
    <div class="container mx-auto flex flex-wrap gap-4 mt-12 px-20">
        ...
        @auth    
        <a href="product/detail-product/{{$item->id}}" class="bg-white  shadow-md card pb-4 transition-all  @auth  hover:scale-105 @else cursor-not-allowed @endauth mt-2 w-60  hover:bg-slate-100 ">
            <figure>
                <img
                class="w-48 h-48"
                src="{{ asset('storage/uploads/' . $item->image1) }}"
                alt="images" />
            </figure>
            <div class="px-4 mt-2">
                <div>
            ...
            @else
            <a href="" class="bg-white  shadow-md card pb-4 transition-all  @auth  hover:scale-105 @else cursor-not-allowed @endauth mt-2 w-60 h-fit hover:bg-slate-100 ">
                <figure>
                    <img
                    class="w-48 h-48"
                    src="{{ asset('storage/uploads/' . $item->image1) }}"
                ...
                <div class="px-4 mt-2">
                    ...
                    <div class="mt-4 justify-between flex gap-2">
                        <div class="flex border cursor-not-allowed text-slate-400 px-6 py-2 rounded-md w-1/2 items-center gap-1">
                            ...
                            <button class="cursor-not-allowed">Cart</button>
                        </div>
