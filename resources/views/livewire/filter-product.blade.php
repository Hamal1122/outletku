...
<div class="container mx-auto flex flex-wrap gap-4 mt-12 px-20">
    ...
    <a href="product/detail-product/{{$item->id}}" class="bg-white  shadow-md card pb-4 transition-all  @auth  hover:scale-105 @else cursor-not-allowed @endauth mt-2 w-60 h-fit hover:bg-slate-100 ">
        <figure>
            <img
