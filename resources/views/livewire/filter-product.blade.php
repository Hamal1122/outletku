...
<div class="flex gap-4 mt-10">
    ...
    <a href="" class="bg-white shadow-md card pb-4 transition-all hover:scale-105 mt-2 w-60 h-fit hover:bg-slate-100 ">
        <figure>
            <img
        ...
        <div class="px-4 mt-2">
            <div>
                ...
                <h1 class="font-light">Rp.{{$item->price}}</h1>  
            ...
            <div class="mt-4 justify-between flex gap-2">
                ...
                <button class="bg-blue-600 text-white px-6 py-2 rounded-md w-1/2 hover:bg-blue-800 transi">Buy</button>
            </div>
        </div>
