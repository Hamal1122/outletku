  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    @csrf
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="phoneNumber" name="phoneNumber" type="number"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
      </div>
      ...
      <div>
        ...
        <a href="{{route('dashboard.user')}}" class="mt-2 flex w-full justify-center rounded-md bg-transparent border border-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-indigo-600 shadow-sm hover:bg-indigo-200 focus-visible:outline focus-visible:outline-2  focus-visible:outline-indigo-600 transition-all">Back</a>
      </div>
    </form>
